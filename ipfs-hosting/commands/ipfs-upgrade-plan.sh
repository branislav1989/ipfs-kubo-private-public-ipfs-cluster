...
# IPFS Plan Upgrade Command
# Allows customers to upgrade their IPFS hosting plan interactively

set -e

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║          🚀 IPFS Hosting - Plan Upgrade Tool 🚀              ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
CURRENT=$(curl -s "$API_URL/ipfs/status" \
  -H "X-API-KEY: $API_KEY" \
...
echo ""
echo "1️⃣  BASIC        - €10/month"
echo "    • 50GB storage"
echo "    • 500GB bandwidth"
echo "    • Basic support"
echo ""
echo "2️⃣  PROFESSIONAL - €25/month"
echo "    • 100GB storage"
echo "    • 2TB bandwidth"
echo "    • Priority support"
echo ""
echo "3️⃣  ENTERPRISE   - €75/month"
echo "    • 500GB storage"
...
UPGRADE_RESPONSE=$(curl -s -X POST "$API_URL/ipfs/upgrade-plan" \
  -H "X-API-KEY: $API_KEY" \
  -H "X-API-SECRET: $API_SECRET" \
